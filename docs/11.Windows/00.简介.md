...
- 如果你只是想快速上手 Windows 使用与配置，优先看 [Windows 配置手册](/windows/settings)、[Windows 命令集合](/windows/command)、[Windows 操作手册](/windows/solution)。
- 当前页更适合作为全局快捷键与基础认知的汇总页，不必一次记完全部快捷键。
...
- 仓库内相关： [Windows](/windows)、[Windows 配置手册](/windows/settings)、[Windows 命令集合](/windows/command)、[Windows 操作手册](/windows/solution)
